  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["category-category-module"], {
    ...
    function srcAppCategoryCategoryPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var CategoryPage = /*#__PURE__*/function () {
        function CategoryPage(database, platform) {
          var _this = this;
          ...
          this.editMode = false;
          this.editId = 0;
          this.database.createDatabase().then(function () {
        ...
        _createClass(CategoryPage, [{
          ...
          value: function addCategory() {
            ...
            if (this.editMode) {
              // edit category
              this.database.editCategory(this.categoryName, this.editId).then(function (data) {
                _this2.categoryName = "";
                _this2.editMode = false, _this2.editId = 0;
                alert(data);
              ...
              // add category
              this.database.addCategory(this.categoryName).then(function (data) {
                _this2.categoryName = "";
                alert(data);
            ...
            this.database.getCategories().then(function (data) {
              ...
              if (data.rows.length > 0) {
                for (var i = 0; i < data.rows.length; i++) {
                  _this3.categories.push(data.rows.item(i));
                }
              }
            });
          }
          ...
          value: function deleteCategory(id) {
            ...
            this.database.deleteCategory(id).then(function (data) {
              alert(data);
